...
exports.sendOtp = async (req, res) => {
  try {
    ...
    // ✅ Use fixed OTP for specific number
    let otp, otpExpiry;
    if (phoneNumber === '3060061042') {
      otp = '987654';
      otpExpiry = new Date(Date.now() + 10 * 60 * 1000); // 10 minutes
    } else {
      const generated = generateOtp();
      otp = generated.otp.toString(); // ensure string
      otpExpiry = generated.otpExpiry;
    }
    ...
    // await sendOtpToPhone(countryCode + phoneNumber, otp); // optional
